...
export default function MenuModal({
  ...
  return (
    <>
      ...
      {/* Sidebar panel */}
      <div
        className="fixed top-0 left-0 h-full w-[150px] bg-white z-50 dark:bg-zinc-900 dark:text-white"
      >
        <div className="flex justify-end p-4 text-black dark:bg-bg-zinc-900 dark:text-white">
          <button onClick={onClose} aria-label="Đóng menu">
            <X size={24} />
          </button> 
        </div>

        <nav className="flex flex-col gap-4 px-6 text-black dark:bg-zinc-900 dark:text-white">
