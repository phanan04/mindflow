      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-8 py-8 border-b border-zinc-200 dark:border-zinc-700">
          ...
          >
            ...
            <label className="flex items-center gap-3 text-sm cursor-pointer">
              ...
              />
              <span className="text-zinc-600 dark:text-slate-400">Tôi đồng ý nhận cập nhật newsletter</span>
            </label>
        ...
        <div className="py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-zinc-700 dark:text-slate-300 font-medium">GameFlow</span>
          </div>
          ...
          <div className="flex items-center gap-6 text-sm text-zinc-500 dark:text-slate-400">
            ...
            <div className="hidden md:flex items-center gap-4">
              <a href="#" className="hover:text-zinc-700 dark:hover:text-slate-200 transition-colors duration-200">Chính Sách</a>
              <a href="#" className="hover:text-zinc-700 dark:hover:text-slate-200 transition-colors duration-200">Điều Khoản</a>
              <a href="/contact" className="hover:text-zinc-700 dark:hover:text-slate-200 transition-colors duration-200">Liên Hệ</a>
            </div>
          </div>
        </div>
