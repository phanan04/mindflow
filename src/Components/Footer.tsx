export default function Footer() {
  return (
    <footer className="bg-gray-100 w-full mx-auto px-4 dark:bg-zinc-900 dark:text-white ">
      <div className="max-w-[1000px] mx-auto flex flex-col md:flex-row gap-6 md:gap-0 py-8">
        {/* Cột bên trái */}
        <div className="flex flex-col w-1/2 gap-4 p-4 dark:bg-zinc-900 dark:text-white">
        ...
        <form
          ...
          method="POST"
          className="flex flex-col gap-4 p-4 w-full md:w-1/2 dark:bg-zinc-900 dark:text-white">
